...
module.exports = function (node, 
  ...
  require("./task/standard_to_wxml_object.js")(templateNode, 
    {
      srcFilePath,
      destFilePath,
      mainClassName,
  ...
  referIncludeNode.forEach(
    (pn, idx) => {
      ...
      destFileDict[(pn.path).replace("." + path.extname, ".wxml") ] = templateStringInner;
  ...
  styleNodes.forEach(
    n=> {
      ...
      processorCssObj(n.styleContent, n.src, n.sourceType, "WXMP");

      n.convertedStyle = exporterCss(n.styleContent, config.minifyCss);

      if (n.src) {
        destFileDict[`${n.src.substr(0, n.src.lastIndexOf("."))}.wxss`] = n.convertedStyle;
      } else {
        destFileDict[`${mainClassName}.wxss`] = n.convertedStyle;
      }
    }
  )
